function [EigVals,FullEigVecs,IdxRetain,Sigma] = FastEigensolverDenoisingS(X,LLPDopts,SpectralOpts,DenoisingOpts,SpatialReg)
...
% idxretain S=S(idxRetain,ideRetain);
    ...
    LLPD = knnLLPD(sortedCCmatrix,th,LLPDopts.KNN);
